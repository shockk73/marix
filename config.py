...
# Ризонинг (thinking) модели: low | medium | high | off.
# У gemini flash-lite thinking по умолчанию ВЫКЛЮЧЕН — low включает его.
LLM_REASONING: str = os.getenv("LLM_REASONING", "low").lower()
